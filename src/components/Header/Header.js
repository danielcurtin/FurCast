  ...
  if (page === 'home') {
    ...
    return (
      <header className="city-header">
        <img src={iconLogo} alt='Cartoon style blue cloud with a white pawprint on top of it, with a yellow sun peeking over the right side of the cloud.' onClick={() => history.push('/')}></img>
